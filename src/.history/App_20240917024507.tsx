...
<div id="logo">
  ...
  <a href="https://web.whatsapp.com/" target='_blank'><img src={whatsappimg} alt='img' className='icons'></img></a>
  <a href="https://www.youtube.com/" target='_blank'><img src={youtubeimg} alt='img' className='icons'></img></a>
  <a href="https://www.youtube.com/" target='_blank'><img src={facebookimg} alt='img' className='icons'></img></a>
  <a href="https://www.youtube.com/" target='_blank'><img src={twitterimg} alt='img' className='icons'></img></a>
