...
<div id="logo">
  <a href="./icons8-insta.svg" target='_blank'><img src={instaimg} alt='icon' className='icons'></img></a>
  <a href="src\components\icons8-whatsapp.svg" target='_blank'><img src={whatsappimg} alt='img' className='icons'></img></a>
  <a href="src\components\icons8-youtube.svg" target='_blank'><img src={youtubeimg} alt='img' className='icons'></img></a>
  <a href=""></a>
  <a href=""></a>
</div>
  </footer>
